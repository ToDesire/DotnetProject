...
namespace StockAPI.Controllers
{
    ...
    public class MostCommandedProduct : ControllerBase
    {
        ...
        {
            var sqlQuery = @"SELECT p.design AS product_name, SUM(s.quantite_entree) AS commanded_quantity, p.description AS product_description, p.image AS product_image, COUNT(e.num_bon_liv) AS command_number
                            FROM Products p 
